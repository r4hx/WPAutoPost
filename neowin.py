...
class Neowin:
    def __init__(self) -> None:
        self.feed = "https://feeds.feedburner.com/neowin-main"
    ...
    def get_content(self, soup: BeautifulSoup) -> str:
        ...
        """
        self.soup = soup
        self.text = self.soup.find("div", class_="article-content")
